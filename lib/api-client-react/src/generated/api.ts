...
export const getTicketsByMonth = async ( options?: RequestInit): Promise<MonthlyCount[]> => {
...
export const getGetTicketsByMonthQueryOptions = <TData = Awaited<ReturnType<typeof getTicketsByMonth>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getTicketsByMonth>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetTicketsByMonthQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getTicketsByMonth>>> = ({ signal }) => getTicketsByMonth({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getTicketsByMonth>>, TError, TData> & { queryKey: QueryKey }
}

export type GetTicketsByMonthQueryResult = NonNullable<Awaited<ReturnType<typeof getTicketsByMonth>>>
export type GetTicketsByMonthQueryError = ErrorType<unknown>



export function useGetTicketsByMonth<TData = Awaited<ReturnType<typeof getTicketsByMonth>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getTicketsByMonth>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
export const getTicketsByStatus = async ( options?: RequestInit): Promise<StatusBreakdown[]> => {
...
export const getTicketsByPriority = async ( options?: RequestInit): Promise<StatusBreakdown[]> => {
...
export const getGetTicketsByPriorityQueryOptions = <TData = Awaited<ReturnType<typeof getTicketsByPriority>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getTicketsByPriority>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetTicketsByPriorityQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getTicketsByPriority>>> = ({ signal }) => getTicketsByPriority({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getTicketsByPriority>>, TError, TData> & { queryKey: QueryKey }
}

export type GetTicketsByPriorityQueryResult = NonNullable<Awaited<ReturnType<typeof getTicketsByPriority>>>
export type GetTicketsByPriorityQueryError = ErrorType<unknown>



export function useGetTicketsByPriority<TData = Awaited<ReturnType<typeof getTicketsByPriority>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getTicketsByPriority>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
